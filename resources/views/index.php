...
<meta name="twitter:image" content="http://i1.wp.com/www.jyroneparker.com/wp-content/uploads/2015/11/credit-card-terminals-accessories.jpg">
    ...
    <nav id="mainNav" class="navbar navbar-default navbar-fixed-top">
        <div class="container-fluid">
            ...
            <div class="navbar-header">
                ...
                <a class="navbar-brand page-scroll" href="#page-top">Parker POS - A Jyrone Parker Product</a>
            </div>
    ...
    <header>
        <div class="header-content">
            <div class="header-content-inner">
                <h1>Just Another Jyrone Parker App</h1>
                <hr>
                <p>I wanted a cool landing page.</p>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-8 col-lg-offset-2 text-center">
                    <h2 class="section-heading">Parker POS</h2>
                    <hr class="light">
                    <p class="text-faded">Parker POS is my own custom POS solution that I personally use when collecting payments on the job.</a></p>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12 text-center">
                    <h2 class="section-heading">I Do Other Things Too :D</h2>
                    <hr class="primary">
                </div>
            </div>
        </div>
            ...
            <div class="row">
                <div class="col-lg-3 col-md-6 text-center">
                    <div class="service-box">
                        ...
                        <p class="text-muted">I have been doing this since I was 8. Software is my passion.</p>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6 text-center">
                    <div class="service-box">
                        <i class="fa fa-4x fa-server wow bounceIn text-primary" data-wow-delay=".1s"></i>
                        <h3>DevOps</h3>
                        <p class="text-muted">I will keep your stuff provisioned, balanced, AND scaled.</p>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6 text-center">
                    <div class="service-box">
                        ...
                        <h3>Up to Date</h3>
                        <p class="text-muted">I am a continuous student and plan on staying that way for life.</p>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6 text-center">
                    <div class="service-box">
                        ...
                        <p class="text-muted">Let me service you!</p>
                    </div>
                </div>
            </div>
        </div>
